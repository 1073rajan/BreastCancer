...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
            ...
            function() {
                ...
                var Aa, Ba = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Ia = function(a, b, c) {
                        var d, e = O.createElementNS("../../../../www.w3.org/2000/svg.html", a),
                            f = /([a-z])([A-Z])/g;
                    ...
                    Ma = function(a) {
                        var b, c = P("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "../../../../www.w3.org/2000/svg.html"),
                            d = this.parentNode,
                            e = this.nextSibling,
    ...
    function(a, b) {
        ...
        E(), h.play = function(a, b) {
            ...
            var b, c;
            for (a = a || m, this._timeline && this._timeline.smoothChildTiming && (b = this._pauseTime, c = b || 0 === b ? b : this._timeline.totalTime(), this._startTime = c - (c - this._startTime) * this._timeScale / a),
                this._timeScale = a, c = this.timeline; c && c.timeline;) c._dirty = !0, c.totalDuration(), c = c.timeline;
            return this
